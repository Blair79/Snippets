...
public class AktuellesDatumJava8 {
	...
	static void formatDateTime() {
		...
		df = DateTimeFormatter.ofPattern("dd.MM.yyyy kk:mm"); // 31.01.2016
																// 20:07
		System.out.println(now.format(df));
	}
	...
	static void formatDate() {
		...
		df = DateTimeFormatter.ofLocalizedDate(FormatStyle.FULL); // Sonntag,
																	// 31.
																	// Januar
																	// 2016
		df = DateTimeFormatter.ofLocalizedDate(FormatStyle.LONG); // 31. Januar
																	// 2016
