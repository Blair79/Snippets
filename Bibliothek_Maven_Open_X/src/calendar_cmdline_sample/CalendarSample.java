	...
	public static void main(String[] args) {
		try {
			...
			client = new com.google.api.services.calendar.Calendar.Builder(httpTransport, JSON_FACTORY, credential)
					.setApplicationName("KiK-Office").build();
			...
			do {
				DateTime timeMax = new DateTime(LocalDateTime.now().plusMonths(1).toString());
				Events events = client.events().list("3h5je7hsq4ujjlm6upbjuu88j4@group.calendar.google.com")
						.setTimeMax(timeMax).setPageToken(pageToken).setTimeMin(now).setOrderBy("startTime")
			...
			/*
			 * addCalendarsUsingBatch(); Calendar calendar = addCalendar();
			 * updateCalendar(calendar); addEvent(calendar);
			 * showEvents(calendar); deleteCalendarsUsingBatch();
