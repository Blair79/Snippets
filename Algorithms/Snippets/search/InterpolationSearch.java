...
public class InterpolationSearch {
	...
	public void search(int[] intArr, int anfang, int ende, int zahl) {
		...
		int grenze = anfang + (int) (((double) ende - anfang) * (zahl - intArr[anfang]) / bereich);
		...
		System.out.println("Anfang: " + anfang + ", Ende: " + ende + ", Grenze: " + grenze);
		if (zahl > intArr[grenze]) {
			...
			System.out.println(zahl + " an Position " + grenze + " des Arrays enthalten.");
		} else {
			System.out.println(zahl + " nicht im Array enthalten.");
		}
	}
