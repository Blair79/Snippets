...
/**
 * Compute the Palindrome of a number by adding the number composed of its
 * digits in reverse order, until a Palindrome occurs. e.g., 42->66 (42+24);
 * 1951->5995 (1951+1591=3542; 3542+2453=5995).
 * <P>
...
public class Main {
	...
	/**
	 * find a palindromic number given a starting point, by calling ourself
	 * until we get a number that is palindromic.
	 */
