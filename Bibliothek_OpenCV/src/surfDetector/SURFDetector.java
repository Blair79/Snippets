...
public class SURFDetector {
	...
	public static void main(String[] args) {
		...
		/*
		 * File lib = null; String os = System.getProperty("os.name"); String
		 * bitness = System.getProperty("sun.arch.data.model");
		 * 
		 * if (os.toUpperCase().contains("WINDOWS")) { if
		 * (bitness.endsWith("64")) { lib = new File("libs//x64//" +
		 * System.mapLibraryName("opencv_java2411")); } else { lib = new
		 * File("libs//x86//" + System.mapLibraryName("opencv_java2411")); } }
		 */
