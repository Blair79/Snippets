...
public class Trend_Curve_Line_in_JavaFX_Chart extends Application {
    ...
    public void start(Stage primaryStage) throws Exception{
        ...
        chart.getStylesheets().add(Trend_Curve_Line_in_JavaFX_Chart.class.getResource("style.css")
             .toExternalForm());
    ...
    public static void main(String[] args) {
        launch(Trend_Curve_Line_in_JavaFX_Chart.class, args);
    }
}